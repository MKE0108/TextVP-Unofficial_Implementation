...
Example:
    python run_experiment.py --mode train \
        --exp_dir new \
        --source_image dataset_old/cat_01.png \
        --target_image dataset_old/cat_01_van_gogh.png \
        --test_image_pattern "Dataset/cat_gemini/*test.png" \
        --coarse_description "a watercolor painting" \
...
cat:
    python Code/run_experiment.py --mode full \
        --device "cuda:0" \
        --exp_dir cat_dog \
        --source_image Dataset/cat_dog/train/cat_01_before.png \
        --target_image Dataset/cat_dog/train/cat_01_after.png \
        --test_image_pattern "Dataset/cat_dog/test/*_before.png" \
        --coarse_description "a dog" \
        --guidance_scale "[1, 3.5, 7.5]" \
        --cross_replace_step "[[0.2, 1.0]]" \
        --num_epochs 50    
...
landscape:
    python Code/run_experiment.py --mode full \
        --device "cuda:1" \
        --exp_dir landscape_foggy \
        --source_image Dataset/landscape_foggy/train/mountain_01_before.png \
        --target_image Dataset/landscape_foggy/train/mountain_01_after.png \
        --test_image_pattern "Dataset/landscape_foggy/test/*_before.png" \
        --coarse_description "A mountain in the fog" \
        --guidance_scale "[1, 3.5, 7.5]" \
        --cross_replace_step "[[0.2, 1.0]]" \
        --num_epochs 50    
"""
