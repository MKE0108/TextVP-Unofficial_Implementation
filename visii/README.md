...
### test操作
dataset放在images/dog_watercolor, 用batch_test.py執行可以跑完test資料夾裡面的image
以下
```
    python batch_test.py \
    --project_name "dog_watercolor" \
    --source_dir "images/dog_watercolor/test" \
    --output_dir "results/dog_watercolor"
```